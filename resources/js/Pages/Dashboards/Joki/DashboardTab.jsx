        ...
        return (
            <div key={task.id} className={`p-6 transition-colors flex flex-col md:flex-row gap-6 ${isRevision ? 'bg-red-50 hover:bg-red-100 border-l-4 border-red-500' : 'hover:bg-gray-50 border-l-4 border-transparent'}`}>
                <div className="flex-1">
                    ...
                    {isRevision && (
                        <div className="mb-4 bg-white/60 p-4 rounded-lg border border-red-200 space-y-3">
                            <div>
                            ...
                            {task.revision_file && (
                                <div className="pt-3 border-t border-red-100">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-flex items-center gap-2 px-3 py-1.5 bg-red-100 text-red-700 rounded-md text-xs font-bold hover:bg-red-200 transition-colors"
                                    >
                                        Download File
