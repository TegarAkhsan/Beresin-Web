                ...
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-slate-500 leading-relaxed mb-6 max-w-sm font-medium">
                            {settings.footer_description || 'Platform jasa digital terpercaya untuk kebutuhan Web Development, UI/UX Design, dan Mobile App. Solusi cepat, aman, dan berkualitas.'}
                        </p>
                        <div className="flex gap-4">
                            {/* Social Icons Placeholder */}
                            <a href={settings.instagram_url || '#'} target="_blank" className="w-10 h-10 rounded-full bg-white border-2 border-slate-900 flex items-center justify-center text-slate-900 hover:bg-slate-900 hover:text-white transition shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:shadow-none hover:translate-x-[1px] hover:translate-y-[1px]">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 font-medium">
                            <li className="flex items-center gap-3">
                                ...
                                <span className="text-slate-600">{settings.email_contact || 'admin@beresin.com'}</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <div className="p-2 bg-white border-2 border-slate-900 rounded-lg">
                                ...
                                <span className="text-slate-600 font-bold">+{settings.whatsapp_number || '62 812-3456-7890'}</span>
                            </li>
                        </ul>
                    </div>
                </div>
