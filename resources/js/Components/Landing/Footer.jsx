            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-indigo-500 text-transparent bg-clip-text mb-4">
                            Beresin.
                        </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-indigo-600 hover:text-white transition">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li><a href="#services" className="hover:text-indigo-400 transition">Layanan</a></li>
                            <li><a href="#how-it-works" className="hover:text-indigo-400 transition">Cara Kerja</a></li>
                            <li><a href="#faq" className="hover:text-indigo-400 transition">FAQ</a></li>
                            <li><a href={route('login')} className="hover:text-indigo-400 transition">Login / Register</a></li>
                        </ul>
                    </div>
